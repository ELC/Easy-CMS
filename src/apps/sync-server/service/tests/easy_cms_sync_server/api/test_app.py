...
from easy_cms_sync_server.api.app import app_factory
from easy_cms_sync_server.api.openapi import main as write_openapi
from easy_cms_sync_server.api.server import server_factory
from easy_cms_sync_server.slices.health.api.handlers import health_unavailable_handler
from easy_cms_sync_server.slices.health.api.responses import ProblemDetails as HealthProblemDetails
from easy_cms_sync_server.slices.health.domain import HealthUnavailable
from easy_cms_sync_server.slices.version.api.handlers import version_unavailable_handler
from easy_cms_sync_server.slices.version.api.responses import ProblemDetails as VersionProblemDetails
from easy_cms_sync_server.slices.version.application import VersionService
...
def test_openapi_writer_creates_checked_in_schema() -> None:
    ...
    assert schema["info"]["title"] == "Sync Server"
...
async def test_version_service_raises_domain_exception_for_missing_distribution() -> None:
    ...
    with pytest.raises(VersionUnavailable, match=r"Sync Server version could not be reported\."):
